...
Naming conventions:
- the voltage source should have a type of "voltage_source" and a name of "V<num>"
- resistors should have a type of "resistor" and a name of "R<num>", where <num> is the resistor number
